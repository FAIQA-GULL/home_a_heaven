...
<div class="container">
	<br><br>
	<!-- <h1>Welcome Admin</h1>	 -->
	<center><h2 class="head">Canceled Order</h2></center>
	<br>
	...
	<table class="table">
		...
		$sql="SELECT * FROM order_info 
		  WHERE cdate = CURDATE() AND O_status = 'canceled'";
		...
		<tbody>
			<tr>
				...
				<td><a href="canceled_orders.php?action=approve&order_id=<?php echo $row['order_id'];?>" class="btn btn-success">Approve</a></td>

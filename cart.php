...
//                 // echo '<script>window.location="filter_cards.php"</script>';
...
<div class="row">
	 ...
	 $data= array();
		...
		<tr>
			...
			<td><input type="hidden" name="product_name" value="<?php echo  $values["item_name"]; ?>">
				...
				<br><a  href="home_product_detail.php?action=delete&product_id=<?php echo  $values['item_id']; ?>">Remove</a>
			</td>
 ...
 <div class="row">
 	...
 	<td><a href="home_collection.php" class="btn btn-outline-dark">Continue to Shoping </a></td>
    <br><br><br>
   <!--  <p>Shipping & taxes calculated at checkout</p> -->
    <td><a href="cart.php" class="btn btn-outline-dark">Update</a></td>

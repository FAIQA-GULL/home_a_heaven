 ...
 <div class="container" id="option">
	...
	<div class="row">
		...
		<select class="form-control" onchange="location = this.value;">
			...
			?>
			<option value="index_nav_collection.php?collection=<?php echo $row['sub_cat'];?>|F"><?php echo $row['sub_cat'];?></option>
     ...
     ?>
        ...
        <div class="col" align="right" >
        	<select class="form-control" name="sort" onchange="location= this.value;">
        		...
        		<option value="index_nav_collection.php?collection=<?php echo $shelve;?>|best">Best Selling</option>

        		<option value="index_nav_collection.php?collection=<?php echo $shelve;?>|A" >

        	     Alphabetically A - Z

                </option>
        		
        		<option value="index_nav_collection.php?collection=<?php echo $shelve;?>|Z">Alphabetically Z - A</option>

        		<option value="index_nav_collection.php?collection=<?php echo $shelve;?>|PL">Price, Low to Hight</option>

        		<option value="index_nav_collection.php?collection=<?php echo $shelve;?>|PH">Price, Hight to Low</option>

        		<option value="index_nav_collection.php?collection=<?php echo $shelve;?>|Dn">Date, new to old</option>

        		<option value="index_nav_collection.php?collection=<?php echo $shelve;?>|Do">Date, old to new</option>
        	</select>
        </div>

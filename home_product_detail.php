...
<div class="container">
	<div class="row">
		...
		<div class="col">
				...
				<?php echo "<img src='image/".$row['image']."' height='600px' width='600px'/>"; ?>
			</div>
			<div class="col">
				 <form method="POST" >
				...
				<br>
				<!-- <a href="cart.php?product_id=<?php echo $row['product_id'];?>&title=<?php echo $row['title'];?>&price=<?php echo $row['price'];?>" class="btn btn-info" name="" >Add to Cart</a> -->
...
<input type="hidden" name="image" value="<?php echo $row['image'] ; ?>">
	...
	<br><br><br><br>
	<center><a href="home_page.php" class="btn btn-warning">Back to Shoping</a></center>
</div>

			...
			<ul class="mainUl">
				<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" id="menu1" href="#">Living Room<span class="caret"></span></a>
					...
					<ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
						<li role="presentation"><a role="menuitem" tabindex="-1" href="home_shelve.php">Shelf</a></li>
						<br>
						<li role="presentation"><a role="menuitem" tabindex="-1" href="home_TV.php">TV Consoles</a></li>
						<br>
						<li role="presentation"><a role="menuitem" tabindex="-1" href="home_table.php">Table</a></li>
						<br>
						<li role="presentation"><a role="menuitem" tabindex="-1" href="home_chair.php">Chair</a></li>
						<br>
						<li role="presentation"><a role="menuitem" tabindex="-1" href="home_rugs.php">Rugs</a></li>
						<br>
						<li role="presentation"><a role="menuitem" tabindex="-1" href="home_lamps.php">Lamps</a></li>
						<br>
						<li role="presentation"><a role="menuitem" tabindex="-1" href="home_bar_stool.php">Bar Stool</a></li>
						<br>
						<li role="presentation"><a role="menuitem" tabindex="-1" href="home_shoe.php">Shoe Rack</a></li>
						<br>
						<li role="presentation"><a role="menuitem" tabindex="-1" href="home_iron.php">Iron Stone</a></li>
					</ul>
...
<div class="row">
	...
	<div class=" col-sm-4">
		<figure>
				<a href="shelve.php">
				<img src="image/shelf0.jpg" onclick="breakfast.php">
				<!-- <figcaption><h5>Shelves</h5></figcaption> -->
			</a>
			<center>
				<h5>Large Corner Shelf Walnut Brown</h5>
	...
	<div class=" col-sm-4">
		<figure>
				<a href="shelve.php">
				<img src="image/shelf2.jpg" onclick="breakfast.php">
				<!-- <figcaption><h5>Shelves</h5></figcaption> -->
			</a>
			<center>
				<h5>Large Corner Shelf Walnut Brown</h5>

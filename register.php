...
<div class="container">
	<div class="row">
		...
		<center>
			<h1 style="color: gray;" class="head">Creat Account</h1>
	...
	<div class="row">
		...
		<input type="" class="form-control" name="first_name" required>
		
		<br>
		<label>Last Name</label>
		<input type="" class="form-control" name="last_name" required>
		...
		<input type="submit" class="btn btn-info btn-lg" name="register_btn" value="CREATE">
		<br>
		<br>

	...
	<div class="row">
		...
		<div class="col-sm-6" style=" margin-right: 0%;">
			...
			<div class="links_div">
				...
				<a href="index_continue_to_shipping.php">Shipping</a> >
...
if (isset($_POST['confirm_order']))
{
	...
	$order = "INSERT INTO `order_info`(`user_email`, `address`, `city`, `postal_code`, `country`, `cash_method`, `billing_address`, `diff_first_name`, `diff_last_name`, `diff_address`, `diff_city`, `diff_country`, `diff_postal`, `diff_phone`,`discount_code`, `total`, `order_id`, `user_id`) 
VALUES('$Email','$Address','$City','$Postal','$Country','$Cash_On_Delivery','$cars','$diff_first','$diff_last','$diff_address','$diff_city','$diff_country','$diff_postal','$diff_phone','$discount_code','$total','$order_id','$user_id')";

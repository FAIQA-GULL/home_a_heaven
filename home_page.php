...
<!-- container -->
	...
	<a href="home_collection.php" id="con_a">
...
<!-- option side portion -->
	...
	<div class="container-fluid" id="option">
		...
		<!-- <div class="second-pg-div"> -->
			...
			<figure class="figure">
				<a href="home_nav_collection.php?collection=Shelves">
		...
		<div class="col-sm-4">
			...
			<figure class="figure">
				<a href="home_nav_collection.php?collection=Living Room">
		...
		<div class="col-sm-4">
			...
			<figure class="figure">
				<a href="home_nav_collection.php?collection=Wall Clocks">
		...
		<div class="col-sm-4">
			...
			<figure class="figure">
				<a href="home_nav_collection.php?collection=Rugs">
		...
		<div class="col-sm-4">
			...
			<figure class="figure">
				<a href="home_nav_collection.php?collection=Table">
				<img src="image/living0.jpg" onclick="breakfast.php">
		...
		<div class="col-sm-4">
			...
			<figure class="figure">
				<a href="home_nav_collection.php?collection=Chair">
...
<!-- 
 ...
 -->
	...
	<!-- 	<div class="col-sm-4">
	   ...
	   <div class="text-center"> <a href="home_nav_collection.php?collection=Décor" class="btn btn-info vew_all_decor">Veiw All</a></div>
	</div>


	<div class="container" id="option">

		<h2 align="center" id="Shelves">Living Room</h2>
		<div class="row">
	 ...
	 <div class="col-sm-4">
	    ...
	    <div class="text-center"> <a href="home_nav_collection.php?collection=Living Room" class="btn btn-info vew_all_decor">Veiw All</a></div>
	</div>
	...
	<div class="container" id="option">
		...
		<h2 align="center" id="Shelves">Wall Clocks</h2>
		<div class="row">
	 ...
	 <div class="col-sm-4">
	    ...
	    <div class="text-center"> <a href="home_nav_collection.php?collection=Wall Clocks" class="btn btn-info vew_all_decor">Veiw All</a></div>
	</div>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col">
				...
				<a href="home_product_detail.php?product_id=<?php  echo $row['product_id'];?>&title=<?php  echo $row['title'];?>" class="btn btn-info">Add to Cart</a></div>
				<ul class="ul">

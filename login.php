...
<div class="container">
	<div class="row">
		...
		<center>
			<h2 style="color: gray;" class="head">Login</h2>
	...
	<form method="post" action="login.php">
		...
		<input type="email" class="form-control" id="form-control" name="user_email" required>
		...
		<br>
		<br>
		<input type="submit" class="btn btn-info btn-lg" name="login_btn" value="SIGN IN">
	
		<br>
		<br>
		<a href="register.php" class="links">Creat Account</a>
	    </center>
	    </form>
		</div>

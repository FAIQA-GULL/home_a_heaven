...
if (isset($_POST['pass']))
{
	...
	$qu= "UPDATE `user_info` SET `user_password`='$pass' WHERE `user_email`='$email'";
...
<div class="container">
	<div class="row">
		...
		if (isset($_POST['forget'])) 
		{
			...
			if (mysqli_num_rows($chk)>0)
			{
				$output = '
				<center>
			<h2 style="color: gray;" class="head">Enter New Password</h2>
	...
	<form method="post" >
		...
		<input type="" class="form-control" id="form-control" name="password" required>
		...
		<br>
		<br>
		<input type="submit" class="btn btn-info btn-lg" name="pass" value="Submit">
		...
		<a href="login.php" class="links">Back to Login</a>
				...
				echo '<script>alert("This Email not exist ! please Check your Email OR sign Up")</script>';
